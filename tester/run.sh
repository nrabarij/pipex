...
test "infiles/basic.txt" "sleep 1" "ls" "outfiles/outfile"
test "infiles/ai.txt" "cat -e" "awk '{print \$9}'" "outfiles/outfile"
test "infiles/ai.txt" "" "awk '{print \$9}'" "outfiles/outfile"
...
test "nonexistingfile" "cat" "sleep 1" "outfiles/outfile"
...
chmod 000 outfiles/outfile_without_permissions
	...
	test "infiles/basic.txt" "sleep 1" "cat -e" "outfiles/outfile_without_permissions"
...
test "infiles/ai.txt" "nocmd" "awk '{print \$9}'" "outfiles/outfile"
test "infiles/global_warming.txt" "nocmd" "awk '{print \$42}'" "outfiles/outfile"
...
LEAKS_ONLY=0
	...
	test "" "cat -e" "" "outfiles/outfile_without_permissions"
	test "infiles/basic.txt" "" "cat -e" "outfiles/outfile"
	test "infiles/basic.txt" "" "cat -e" "outfiles/outfile_without_permissions"
	test "infiles/basic.txt" "cat -e" "" "outfiles/outfile"
	test "infiles/basic.txt" "cat -e" "" "outfiles/outfile_without_permissions"
#LEAKS_ONLY=0
...
print_header "BONUS AWK, GREP, CAT --> BASIC"
bonus "infiles/basic.txt" "awk '{print \$1}'" "cat" "" "grep 'Hello world'" "outfiles/outfile"
bonus "infiles/basic.txt" "cat" "" "awk '{print \$1}'" "grep 'Hello world'" "outfiles/outfile"
bonus "infiles/basic.txt" "awk '{print \$1}'" "grep 'Hello world'" "" "cat" "outfiles/outfile"

print_header "BONUS AWK, GREP, CAT --> AI"
bonus "infiles/ai.txt" "" "cat" "grep 'Hello world'" "awk '{print \$1}'" "outfiles/outfile"
bonus "infiles/ai.txt" "cat" "awk '{print \$1}'" "" "grep 'Hello world'" "outfiles/outfile"
bonus "infiles/ai.txt" "awk '{print \$1}'" "" "cat" "grep 'Hello world'" "outfiles/outfile"
bonus "infiles/ai.txt" "cat" "grep 'Hello world'" "" "awk '{print \$1}'" "outfiles/outfile"
bonus "infiles/ai.txt" "" "awk '{print \$1}'" "cat" "grep 'Hello world'" "outfiles/outfile"

print_header "BONUS AWK, GREP, CAT --> GLOBAL WARMING"
bonus "infiles/global_warming.txt" "cat" "awk '{print \$1}'" "grep 'Hello world'" "" "outfiles/outfile"
bonus "infiles/global_warming.txt" "" "cat" "awk '{print \$1}'" "grep 'Hello world'" "outfiles/outfile"
bonus "infiles/global_warming.txt" "awk '{print \$1}'" "grep 'Hello world'" "" "cat" "outfiles/outfile"
bonus "infiles/global_warming.txt" "grep 'Hello world'" "cat" "awk '{print \$1}'" "" "outfiles/outfile"
...
print_header "BONUS HERE_DOC AWK"
bonus "here_doc" "EOF" "awk '{print \$1}'" "cat" "" "grep 'Hello world'" "outfiles/outfile"
bonus "here_doc" "EOF" "cat" "" "awk '{print \$1}'" "grep 'Hello world'" "outfiles/outfile"
bonus "here_doc" "EOF" "awk '{print \$1}'" "grep 'Hello world'" "" "cat" "outfiles/outfile"
bonus "here_doc" "EOF" "" "cat" "grep 'Hello world'" "awk '{print \$1}'" "outfiles/outfile"
bonus "here_doc" "EOF" "cat" "awk '{print \$1}'" "" "grep 'Hello world'" "outfiles/outfile"
bonus "here_doc" "EOF" "awk '{print \$1}'" "" "cat" "grep 'Hello world'" "outfiles/outfile"
bonus "here_doc" "EOF" "cat" "grep 'Hello world'" "" "awk '{print \$1}'" "outfiles/outfile"
bonus "here_doc" "EOF" "" "awk '{print \$1}'" "cat" "grep 'Hello world'" "outfiles/outfile"
...
bonus "here_doc" "EOF" "" "cat" "awk '{print \$1}'" "grep 'Hello world'" "outfiles/outfile"
bonus "here_doc" "EOF" "awk '{print \$1}'" "grep 'Hello world'" "" "cat" "outfiles/outfile"
bonus "here_doc" "EOF" "grep 'Hello world'" "cat" "awk '{print \$1}'" "" "outfiles/outfile"
...
bonus "here_doc" "END" "grep success" "cat -e" "sleep 1" "outfiles/outfile"
bonus "here_doc" "EOF" "sleep 1" "" "grep test" "cat -e" "outfiles/outfile"
bonus "here_doc" "EOF" "nocmd" "grep warning" "cat -e" "outfiles/outfile"
bonus "here_doc" "END" "grep fatal" "wc -c" "sleep 1" "outfiles/outfile"
bonus "here_doc" "EOF" "grep hello" "" "grep $" "cat -e" "sleep 1" "outfiles/outfile"
bonus "here_doc" "END" "cat -e" "" "wc -w" "sleep 1" "outfiles/outfile"
bonus "here_doc" "EOF" "grep world" "nocmd" "cat -e" "outfiles/outfile"
bonus "here_doc" "END" "sleep 1" "grep no" "" "cat -e" "outfiles/outfile"
bonus "here_doc" "EOF" "grep yes" "cat -e" "sleep 1" "" "outfiles/outfile"
bonus "here_doc" "EOF" "wc -m" "grep error" "" "sleep 1" "outfiles/outfile"
bonus "here_doc" "END" "grep warning" "" "grep no" "sleep 1" "cat -e" "outfiles/outfile"
bonus "here_doc" "EOF" "cat -e" "wc -c" "sleep 1" "outfiles/outfile"
bonus "here_doc" "EOF" "" "grep test" "cat -e" "nocmd" "outfiles/outfile"
bonus "here_doc" "END" "grep hello" "" "cat -e" "sleep 1" "outfiles/outfile"
bonus "here_doc" "EOF" "grep world" "cat -e" "sleep 1" "outfiles/outfile"
bonus "here_doc" "END" "grep warning" "" "wc -l" "cat -e" "outfiles/outfile"
bonus "here_doc" "EOF" "sleep 1" "grep success" "cat -e" "outfiles/outfile"
bonus "here_doc" "END" "grep fatal" "cat -e" "" "sleep 1" "outfiles/outfile"
bonus "here_doc" "EOF" "grep hello" "cat -e" "sleep 1" "nocmd" "outfiles/outfile"

print_header "BONUS HERE_DOC LIMITER ERROR CHECKING"
bonus "here_doc" "EOFS" "grep no" "cat -e" "" "cat -e" "sleep 1" "outfiles/outfile"
bonus "here_doc" "EOFS" "grep no" "cat -e" "grep $" "cat -e" "sleep 1" "outfiles/outfile"
bonus "here_doc" "EOFS" "grep Hello" "cat -e" "grep $" "cat -e" "sleep 1" "nocmd" "outfiles/outfile"
...
bonus "here_doc" "ENDS" "grep success" "cat -e" "sleep 1" "outfiles/outfile"
